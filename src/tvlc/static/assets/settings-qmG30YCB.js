import{getStoredProfiles as w,getActiveProfile as S,openProfileEditor as u}from"./profiles-DKBXu0ov.js";import{g as z}from"./auth-ZyEo1J3_.js";function y(){I()}function I(){const p=document.getElementById("settingsModal");p&&p.remove();const l=z(),f=w(),x=S(),h=l&&l.email?l.email.split("@")[0]:"My Household",v=localStorage.getItem("veedeeoh_account_name")||h;let s=[];try{const e=localStorage.getItem("veedeeoh_pending_invites")||"[]";s=JSON.parse(e)}catch{s=[]}const t=document.createElement("div");t.id="settingsModal",t.style.cssText=`
